    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-3 sm:px-4 py-6 sm:py-8">
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <h1 className="text-white text-4xl font-bold drop-shadow-lg">Arun Thai</h1>
        ...
        <div className="w-full max-w-md">
          <h2 className="text-1xl sm:text-2xl md:text-3xl font-normal text-gray-900 mb-2 leading-tight">
            Welcome back to <br /><span className="font-bold">Arun Thai Admin Dashboard!</span>
          </h2>
