...
import { BarChart3, BellRing, BookOpen, ChevronDown, ChevronRight, CreditCard, FileText, GalleryVerticalEnd, Headphones, LayoutGrid, ListChecks, LogOut, Mail, MailCheck, Send, Settings, Users } from 'lucide-react'
...
function Sidebar({ isOpen = true, onNavigate }) {
  ...
  const navigationGroups = [
    ...
    { key: 'sales', label: 'Sales', items: [{ label: 'Payments', path: '/review-payment', icon: CreditCard, badge: badges.payments }, { label: 'Promo codes', path: '/promo-codes', icon: CreditCard }] },
  ]
