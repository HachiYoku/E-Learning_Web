...
const { createSupportTicket, getMySupportTickets, getSupportTickets, getActionableSupportCount, updateTicketStatus, replyToSupportTicket, replyToOwnSupportTicket } = require("../controllers/supportTicketController");
...
router.get("/actionable-count", validateToken, requireAdmin, getActionableSupportCount);
